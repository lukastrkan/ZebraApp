...
namespace ZebraApp.Api.Model
{
    ...
    /// Event.
    /// </summary>
    [DataContract(Name = "FilamentEvent")]
    public partial class FilamentEvent : IValidatableObject
    {
        ...
        /// <param name="payload">Updated filament. (required).</param>
        public FilamentEvent(EventType type = default(EventType), ResourceEnum resource = default(ResourceEnum), string date = default(string), Filament payload = default(Filament))
        {
            this.Type = type;
            ...
            if (date == null)
            {
                throw new ArgumentNullException("date is a required property for FilamentEvent and cannot be null");
            }
            this.Date = date;
            // to ensure "payload" is required (not null)
            if (payload == null)
            {
                throw new ArgumentNullException("payload is a required property for FilamentEvent and cannot be null");
            }
