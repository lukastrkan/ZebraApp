...
namespace ZebraApp.Api.Model
{
    ...
    /// Event.
    /// </summary>
    [DataContract(Name = "SettingEvent")]
    public partial class SettingEvent : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SettingEvent" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SettingEvent() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SettingEvent" /> class.
        /// </summary>
        ...
        /// <param name="payload">Updated setting. (required).</param>
        public SettingEvent(EventType type = default(EventType), ResourceEnum resource = default(ResourceEnum), string date = default(string), SettingKV payload = default(SettingKV))
        {
            this.Type = type;
            ...
            if (date == null)
            {
                throw new ArgumentNullException("date is a required property for SettingEvent and cannot be null");
            }
            this.Date = date;
            // to ensure "payload" is required (not null)
            if (payload == null)
            {
                throw new ArgumentNullException("payload is a required property for SettingEvent and cannot be null");
            }
        ...
        public SettingKV Payload { get; set; }
