...
namespace ZebraApp.Api.Model
{
    ...
    public partial class Vendor : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="Vendor" /> class.
        /// </summary>
        /// <param name="id">Unique internal ID of this vendor. (required).</param>
        /// <param name="registered">When the vendor was registered in the database. UTC Timezone. (required).</param>
        /// <param name="name">Vendor name. (required).</param>
        /// <param name="comment">comment.</param>
        /// <param name="emptySpoolWeight">emptySpoolWeight.</param>
        /// <param name="externalId">externalId.</param>
        /// <param name="extra">Extra fields for this vendor. All values are JSON-encoded data. Query the /fields endpoint for more details about the fields. (required).</param>
        public Vendor(int id = default(int), string registered = default(string), string name = default(string), string comment = default(string), decimal? emptySpoolWeight = default(decimal?), string externalId = default(string), Dictionary<string, string> extra = default(Dictionary<string, string>))
        {
            this.Id = id;
            // to ensure "registered" is required (not null)
            if (registered == null)
            {
                throw new ArgumentNullException("registered is a required property for Vendor and cannot be null");
            }
            this.Registered = registered;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for Vendor and cannot be null");
            }
            this.Name = name;
            // to ensure "extra" is required (not null)
            if (extra == null)
            {
                throw new ArgumentNullException("extra is a required property for Vendor and cannot be null");
            }
            this.Extra = extra;
        ...
        /// </summary>
        /// <value>Unique internal ID of this vendor.</value>
        ...
        /// </summary>
        /// <value>When the vendor was registered in the database. UTC Timezone.</value>
        ...
        /// </summary>
        /// <value>Extra fields for this vendor. All values are JSON-encoded data. Query the /fields endpoint for more details about the fields.</value>
