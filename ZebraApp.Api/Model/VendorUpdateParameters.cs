...
namespace ZebraApp.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VendorUpdateParameters")]
    public partial class VendorUpdateParameters : IValidatableObject
    {
        ...
        public VendorUpdateParameters(string name = default(string), string comment = default(string), decimal? emptySpoolWeight = default(decimal?), string externalId = default(string), Dictionary<string, string> extra = default(Dictionary<string, string>))
        {
            this.Name = name;
